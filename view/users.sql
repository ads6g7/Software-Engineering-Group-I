...
---added this line from original code in order to test the database
...
--moved this table from original file to be above the users.courses
--since the users.courses referrences users.professors
...
--added this line to test insertion of database
INSERT INTO users.professors VALUES ('x','Dr. X');

--this table needed to be below professors and above teaches to 
--allows the database to be initialized correctly.
--Table: users.courses
--Columns:
...
CREATE TABLE users.courses(
	...
	courseNum	INTEGER,
	instructor	VARCHAR(30) REFERENCES users.professors,
	TA			VARCHAR(30) DEFAULT NULL,
	description	VARCHAR(200)
);

--used this line to test the database
INSERT INTO users.courses VALUES(59500,'Computer Science',1050,'x','Guy1','Algorithm Design and Programming 1');
